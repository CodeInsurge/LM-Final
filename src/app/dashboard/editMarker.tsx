...
const EditMarker = () => {
    ...
    const [UserProfileName, setUserProfileName] = useState({ f_name: "", l_name: "", u_name: "", u_id: "" })
    ...
    //DatePicker Birth 
    const [selectedDateBirth, setSelectedDateBirth] = useState<string>('');

    const handleDateChangeBirth = (e: ChangeEvent<HTMLInputElement>) => {
        setSelectedDateBirth(e.target.value);
    };
    //DatePicker death
    const [selectedDateDeath, setSelectedDateDeath] = useState<string>('');

    const handleDateChangeDeath = (e: ChangeEvent<HTMLInputElement>) => {
        setSelectedDateDeath(e.target.value);
    };
    //VideoUploader
    ...
    useEffect(() => {
        const fetchProfilePhotoUrl = async () => {
            try {
                ...
                setUserProfileName({ f_name: imageData.f_name, l_name: imageData.l_name, u_name: imageData.u_name, u_id: imageData.u_id });
            } catch (error) {
                            ...
                            <div className="">
                                {UserProfileName ? (
                                    <h3 className="text-[25px] lg:text-4xl font-[poppins] font-bold leading-normal mb-2 text-[#4C4448] mb-2">
                                        {UserProfileName.f_name} {UserProfileName.l_name} <span className="text-[#0D6EFD]">#{UserProfileName.u_id}</span>
                                    </h3>
                                ) : (
                                    <h3 className="text-[25px] lg:text-4xl font-[poppins] font-bold leading-normal mb-2 text-[#4C4448] mb-2">
                                        ...Loading
                                    ...
                                    <div className="block lg:flex">
                                        <div className="w-[100%] lg:w-[30%] border-r border-gray-300">
                                            ...
                                            <TabList className="tababout">
                                                <Tab className="mainprofile32586">Details</Tab>
                                                <Tab className="mainprofile32586">Biography</Tab>
                                                <Tab className="mainprofile32586">Family&nbsp;and&nbsp;Relationships</Tab>
                                                <Tab className="mainprofile32586">Places&nbsp;Lived</Tab>
                                                <Tab className="mainprofile32586">Work&nbsp;and&nbsp;Education</Tab>
                                                <Tab className="mainprofile32586">Eulogy</Tab>
                                            </TabList>
                                        </div>
                                                    ...
                                                    <div className="bg-white rounded-[30px] p-[15px]">
                                                        ...
                                                        <div className="flex gap-[20px] pt-[20px] lg:px-[20px]">
                                                            <div className="w-full">
                                                                <label htmlFor="picker_B" className="block text-gray-700 text-sm font-bold mb-2">Date of Birth</label>
                                                                <input
                                                                    type="date"
                                                                    id="picker_B"
                                                                    name="picker_B"
                                                            ...
                                                            <div className="w-full">
                                                                <label htmlFor="picker_D" className="block text-gray-700 text-sm font-bold mb-2">Date of Death</label>
                                                                <input
                                                                    type="date"
                                                                    id="picker_D"
                                                                    name="picker_D"
                                                                    value={selectedDateDeath}
...
export default withLoadingsppiner(EditMarker);
